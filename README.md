...
<em><p align="right">Currently working on: <a href="https://github.com/jnorgini/spring-aws-s3">API RESTful integrada ao AWS S3 e containerizada com Docker Compose</p></h4></em>
